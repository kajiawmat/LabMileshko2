...
class Program
{
	public static void Main(string[] args)
	{
		...
		try
        {
			Console.WriteLine(RomanNumber.Add(r, r1));
			Console.WriteLine(RomanNumber.Sub(r, r1));
			Console.WriteLine(RomanNumber.Mul(r, r1));
			Console.WriteLine(RomanNumber.Div(r, r1));
		}
		catch(Exception e)
        {
			Console.WriteLine(e);
